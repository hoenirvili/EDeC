...
class UploadHandler {
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options  = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/public/media/' . date('Y') . '/' . date('m') . '/',
            'upload_url' => $this->get_full_url() . '/public/media/' . date('Y') . '/' . date('m') . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'accept_file_types' => '/^.*\.(jpg|jpeg|png|gif|txt|psd|doc|docx|zip|tar|xls|xlxs|pdf|mp3|avi|mp4|wmv|ppt|eps|cdr|csv)$/',
            ...
            */
            ...
            'image_versions' => $GLOBALS['image_sizes'],
